...
def save_csv_report(session_folder: Path, test_data: dict[str, Any]) -> Path:
    ...
    report_path = session_folder / "reports" / "test_result.csv"
    report_path = session_folder / "reports" / "test_summary.txt"
    report_path = session_folder / "reports" / "test_result.json"
